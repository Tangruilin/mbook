...
$(function () {
    ...
    $(".change-update").change(function () {
        var _this = $(this), _url = _this.attr("data-url"), field = _this.attr("name"),
    ...
    $(".ajax-form [type=submit]").click(function (e) {
        e.preventDefault();
        var _this = $(this), form = $(this).parents("form"), method = form.attr("method"), action = form.attr("action"),
            data = form.serialize(), _url = form.attr("data-url");
