$(document).ready(function () {
    ...
    var iconconf = {
        'options-autodiff': {
            get: function () {
                return ed.mergely('options').autoupdate
            },
            set: function (value) {
        ...
        'options-ignorews': {
            get: function () {
                return ed.mergely('options').ignorews
            },
            set: function (value) {
        ...
        'options-ignorecase': {
            get: function () {
                return ed.mergely('options').ignorecase
            },
            set: function (value) {
        ...
        'options-sidebars': {
            get: function () {
                ...
                return ed.mergely('options').sidebar
            },
            set: function (value) {
        ...
        'options-viewport': {
            get: function () {
                ...
                return ed.mergely('options').viewport
            },
            set: function (value) {
        ...
        'options-swapmargin': {
            get: function () {
                return (ed.mergely('options').rhs_margin == 'left');
            },
            set: function (value) {
        ...
        'options-linenumbers': {
            get: function () {
                ...
                return ed.mergely('options').line_numbers
            },
            set: function (value) {
        ...
        'options-wrap': {
            get: function () {
                console.log('wrap', this);
                return ed.mergely('options').wrap_lines
            },
            set: function (value) {
        ...
        'edit-left-readonly': {
            get: function () {
                return ed.mergely('cm', 'lhs').getOption('readOnly');
            },
            set: function (value) {
                ed.mergely('cm', 'lhs').setOption('readOnly', value);
            }
        },
        'edit-right-readonly': {
            get: function () {
                return ed.mergely('cm', 'rhs').getOption('readOnly');
            },
            set: function (value) {
                ed.mergely('cm', 'rhs').setOption('readOnly', value);
            }
        }
    }
    ...
    function importFiles(ed) {
        ...
        function file_load(target, side) {
            ...
            reader.onload = function (evt) {
                trigger('loaded', evt.target.result);
            }
    ...
    function colorSettings(ed) {
        ...
        var conf = {
            'c-border': {
                id: '#c-border', getColor: function () {
                    return sc.css('border-top-color');
                }, setColor: function (color) {
                    $('#' + this.id).val(color)
                }
            },
            'c-bg': {
                id: '#c-bg', getColor: function () {
                    return sc.css('background-color');
                }, setColor: function (color) {
                    $('#' + this.id).val(color)
                }
            },
            'a-border': {
                id: '#a-border', getColor: function () {
                    return sa.css('border-top-color');
                }, setColor: function (color) {
                    $('#' + this.id).val(color)
                }
            },
            'a-bg': {
                id: '#a-bg', getColor: function () {
                    return sa.css('background-color');
                }, setColor: function (color) {
                    $('#' + this.id).val(color)
                }
            },
            'd-border': {
                id: '#d-border', getColor: function () {
                    return sd.css('border-top-color');
                }, setColor: function (color) {
                    $('#' + this.id).val(color)
                }
            },
            'd-bg': {
                id: '#d-bg', getColor: function () {
                    return sd.css('background-color');
                }, setColor: function (color) {
                    $('#' + this.id).val(color)
                }
            }
